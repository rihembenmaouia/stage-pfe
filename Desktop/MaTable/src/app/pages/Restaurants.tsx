...
export function Restaurants() {
  ...
  const filters = { type: 'restaurant', city: city || undefined, hasEvent: hasEvent || undefined };
  ...
  return (
    <div className="py-8 md:py-12">
      <Container>
        <SectionTitle subtitle="Découvrez les meilleurs restaurants en Tunisie">Restaurants</SectionTitle>
        <div className="mb-8">
            ...
            <Card className="p-6 sticky top-24">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input type="number" value={maxPrice} onChange={(e) => setMaxPrice(e.target.value)} placeholder="100" min={0} className="w-full px-4 py-2.5 rounded-lg bg-landing-bg border border-landing-border text-landing-text focus:ring-2 focus:ring-landing-gold" />
                </div>
              </div>
            </Card>
          </aside>
          <div className="flex-1 min-w-0">
            <p className="text-landing-text-muted text-sm mb-6">{filtered.length} restaurant{filtered.length !== 1 ? 's' : ''} trouvé{filtered.length !== 1 ? 's' : ''}</p>
            {isLoading ? (
              ...
              <Card className="p-12 text-center">
                <p className="text-landing-text-muted mb-4">Aucun restaurant ne correspond à vos critères.</p>
